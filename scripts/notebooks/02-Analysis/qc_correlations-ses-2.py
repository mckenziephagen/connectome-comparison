...
print("LASSO MSMALL", len(msmall_lasso_sig_list) ) 
...
print("Pearson MSMAll:", len(msmall_pearson_sig_list) ) 
...
print("UoI MSMALL:", len(msmall_uoi_sig_list))

# +
msmall_lasso_plot_df = pd.DataFrame({'model': 'LASSO' , 
                                'sig_corr': msmall_lasso_corr_list, 
                                'proc_type': 'MSMAll', 
                                 'covariates': 'True'})


msmall_pearson_plot_df = pd.DataFrame({'model': 'Pearson' , 
...
xcpd_pearson_plot_df = pd.DataFrame({'model': 'Pearson' , 
                                  'sig_corr': xcpd_pearson_corr_list, 
                                  'proc_type': 'xcpd', 
                                 'covariates': 'True'})


xcpd_uoi_plot_df = pd.DataFrame({'model': 'Pearson' , 
                                  'sig_corr': xcpd_pearson_corr_list, 
                                  'proc_type': 'xcpd', 
                                 'covariates': 'True'})
...
ax = sns.violinplot(data=plot_df, x="model", y="sig_corr", hue="proc_type")
